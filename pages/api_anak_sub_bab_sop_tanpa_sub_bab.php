...
$query_anak_sub_bab_tanpa_sub_bab = mysqli_query($con, "SELECT * FROM tb_anak_sub_bab_sop_tanpa_sub_bab JOIN tb_anak_sub_bab_sop ON tb_anak_sub_bab_sop.id_anak_sub_bab_sop  = tb_anak_sub_bab_sop_tanpa_sub_bab.id_anak_sub_bab_sop  WHERE tb_anak_sub_bab_sop_tanpa_sub_bab.id_anak_sub_bab_sop = '$id_anak_sub_bab_sop'");
