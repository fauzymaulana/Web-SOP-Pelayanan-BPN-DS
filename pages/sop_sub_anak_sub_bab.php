...
if (isset($_POST['submit'])) {
  ...
  //query untuk menyimpan data judul sub anak sub bab sop
              ...
              ?>
                ...
                <div class="box-body">
                  ...
                  <div class="0 kotak" id="ktk" hidden>
                    ...
                    <div class="box-content" id="tabel" style="display: none;">
                      <div class="box-body table-responsive ">
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            <?php
                            $no = 1;
                            $select_tb_pasal = mysqli_query($con, "SELECT * FROM tb_anak_sub_bab_sop_tanpa_sub_bab JOIN tb_nama_uu USING(id)  WHERE id_anak_sub_bab_sop= '$get_id_anak_sub_bab_sop'");
                  ...
                  <div class="1 kotak" id="ktkk" hidden>
                    <div class="box-header justify-content-between ml-auto">
                      <button type="button" class="btn btn-primary pull-right" style="margin-top: 10px; margin-right: 10px;" data-toggle="modal" data-target="#exampleModalTambah">
                        <i class="fa fa-plus"></i> Tambah Sub Bab
                      </button>
                    </div>
