                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="lihatadmin.php"><i class="fa fa-angle-double-right active"></i> Data Pengguna Admin</a></li>
...
<!-- Modal edit admin -->
<!-- <div class="modal" id="dataadmin<?=$dtid;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">Ubah Data Admin</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
      </button>
  </div>
  <form action="./proses/edit_adm.php" method="POST">
    ...
    $sql = mysqli_query($con, "SELECT * FROM tb_admin WHERE id = '$id'");
          ...
          <div class="container-fluid"> 
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                      <label for="validationServer01">Nama Lengkap</label><span class="text-red">*</span></label>
                      <input type="text" class="form-control is-invalid" name="namamodal" id="validationServer01" value="<?= $dt['nama']; ?>" required>
                                 <!--  <div class="invalid-feedback">
                                    Masukkan nama lengkap.-->
                                </div>
                                <div class="form-group">
                                  <label for="validationServer02">Email</label><span class="text-red">*</span></label>
                                  <input type="email" class="form-control is-invalid" name="emailmodal" id="validationServer02" value="<?= $dt['email'] ?>" required>
                                  <!-- <div class="invalid-feedback">
                                    Masukkan email.
                                </div> -->
                            </div>
                        ...
                        <div class="form-group">
                          <label for="validationServer03">Password</label><span class="text-red">*</span></label>
                          <input type="password" class="form-control" name="passwmodal" placeholder="masukkan password" required>
                        </div>
              </div>
          </div>
