                ...
                ?>
                    ...
                    <form action="./proses/tambah_lihat_sk_bab_pasal.php" id="form" method="POST">
                      <div class="form-group row">
                        ...
                        <div class="col-md-8">
                          <input type="text" class="form-control" name="nama_kumpulan_uu" id="nama_kumpulan_uu" value="<?= $dt['nama_uu']; ?>" required readonly>
                      ...
                      <div class="form-group row">
                        <span class="col-md-3">Judul Bab</span>
                        <div class="col-md-8">
                      ...
                      <div class="form-group row">
                        <span class="col-md-3">Nomor Urut Pasal</span>
                        <div class="col-md-8">
                          <input type="number" class="form-control" id="nomor_urut_pasal" name="nomor_urut_pasal" >
                        </div>
                      </div>

                      <div class="form-group row">
                        <span class="col-md-3">Isi Pasal</span>
                        <div class="col-md-8">
                        <textarea class="ckeditor" id="isi_pasal" name="isi_pasal" rows="10" cols="80" required></textarea>
                        </div>
                      </div> -->
