...
<body class="skin-black">
                ...
                <form action="./proses/tambah_form_sk.php" method="POST">
                  ...
                  <div class="control-group">
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <select class="select form-control" id="id_add_select" name="add_select" >
                          <?php
                  ...
                  <!-- <p>Jika anda mengklik maka, akan menghilang</p>
                  ...
                  <div class="copy" >
                    <div class="control-group">
                      <div class="form-group row">
                        <label class="col-md-3" name="num_bab_" id="num_bab_" >Bab </label>
                        <div class="col-md-9">
                          <input type="text" name="bab1" id="bab12" class="form-control col-md-9" placeholder="Masukkan judul bab"  >
                          <textarea class="ckeditor col-md-8" id="bab_" name="bab" rows="10" cols="80"  >
  ...
  <script type="text/javascript">
    ...
    // function opsi(value) {
    //     var a = $("#id_add_select").val();
    //     if (a == "Tidak") {
    //       document.getElementById("num_bab_").hidden = true;
    //       document.getElementById("bab12").hidden = true;
    //       document.getElementById("bab_").hidden = true;
    //     }else{
    //       document.getElementById("num_bab_").hidden = false;
    //       document.getElementById("bab12").hidden = false;
    //       document.getElementById("bab_").hidden = false;
    //     }
    //   }
