                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header justify-content-between ml-auto">
                                <h3 class="box-title">Data BAB SOP</h3>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead class="bg-olive">
                                        <tr>
                                            ...
                                            <th class="text-center">Bab Pembahasan</th>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="lihat_sop_bab_show_detail_per_bab.php?id=<?= $dt['id']; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Lihat</a>
