                    ...
                    <div class="box">
                      ...
                      <div class="box-body">
                        ...
                        <form action="./proses/tambah_form_sk.php" id="form" method="POST">
                            ...
                            for ($i=1; $i <= $inp_jlh_bab; $i++) { 
                             ...
                             <div class="control-group inpGroup">
                              <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                  <input type="text" name="judul_bab<?=$i?>" id="judul_bab" class="form-control col-md-8" placeholder="Masukkan judul bab <?=$i?>" required>
                                  <!-- sampai di cara masukkan form input untuk pasal pasal di tiap bab -->
                                    <input type="number" name="inp_jlh_pasal_per_bab" id="inp_jlh_pasal_per_bab" class="form-control" placeholder="masukkan jumlah pasal di bab ini">
                          ...
                          <input type="submit"  name="submit" id="submit" class="col btn btn-primary" value="Simpan" onclick="make()">
                        </form>
