...
$query = "DELETE FROM tb_anak_sub_anak_sub_bab_sop_tanpa_sub_bab WHERE id_anak_sub_anak_sub_bab_sop_tanpa_sub_bab = '$get_id_anak_sub_anak_sub_bab_sop_tanpa_sub_bab'";
