...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($con, $input_sop_sub_bab_tanpa_sub_bab)) {
        ...
        header("location:../sop_sub_bab.php?id=" . $id . "&id_bab_utama_sop=" . $id_bab_utama_sop);
        ...
        header("location:../sop_sub_bab.php?id=" . $get_id . "&id_bab_utama_sop=" . $get_id_bab_utama_sop);
        // echo "Gagal";
    }
}
