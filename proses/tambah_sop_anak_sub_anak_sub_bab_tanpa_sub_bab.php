...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($con, $input_sop_anak_sub_bab_tanpa_sub_bab)) {
        header("location:../pages/sop_sub_anak_sub_bab.php?id=" . $txt_id_sub_bab . "&id_bab_utama_sop=" . $txt_id_bab_utama_sop_sub_bab . "&id_sub_bab_sop=" .$txt_id_sub_bab_sop_sub_bab . "&id_anak_sub_bab_sop=" .$txt_id_anak_sub_bab_sop_sub_bab . "&pesan=berhasil");
        
    } else {
        header("location:../pages/sop_sub_anak_sub_bab.php?id=" . $txt_id_sub_bab . "&id_bab_utama_sop=" . $txt_id_bab_utama_sop_sub_bab . "&id_sub_bab_sop=" .$txt_id_sub_bab_sop_sub_bab . "&id_anak_sub_bab_sop=" .$txt_id_anak_sub_bab_sop_sub_bab . "&pesan=gagal");
