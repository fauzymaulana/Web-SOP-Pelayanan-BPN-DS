...
$sql_edit = "UPDATE tb_anak_sub_bab_sop SET id = '$txt_id_modal_sub_bab', id_bab_utama_sop='$txt_id_bab_utama_sop_modal_sub_bab',id_sub_bab_sop='$get_id_sub_bab_sop', urutan_sub_bab =  '$edit_select_bab', judul_sub_bab = '$edit_judul_bab', tanggal_pembuatan='$edit_tgl_bab_modal' WHERE id_anak_sub_bab_sop = '$get_id_anak_sub_bab_sop'";
